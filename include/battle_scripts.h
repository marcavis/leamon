...
extern const u8 BattleScript_TargetAnyStatusHeal[];
...
extern const u8 BattleScript_TargetAbilityStatRaiseOnMoveEnd1[];
extern const u8 BattleScript_TargetAbilityStatRaiseOnMoveEnd2[];
extern const u8 BattleScript_TargetAbilityStatRaiseOnMoveEnd3[];
