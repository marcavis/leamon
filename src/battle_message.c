...
static const u8 sText_PkmnMakesFairyMiss[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} dispelled\nthe power of the FAIRY move!");
...
static const u8 sText_OvertimeEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} wants to\nreally impress its boss now!");
...
static const u8 sText_PkmnOpenEyesConcentrate[] = _("{B_ATK_NAME_WITH_PREFIX} opened its eyes for an\ninstant and concentrated!");
...
static const u8 sText_AbilityRaisedStatSharply[] = _("{B_DEF_ABILITY} raised {B_DEF_NAME_WITH_PREFIX}'s\n{B_BUFF1} sharply!");
...
static const u8 sText_ConniptionFailedMessage[] = _("{B_ATK_NAME_WITH_PREFIX} is not angry enough\nto throw a conniption fit!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_ABILITYRAISEDSTATSHARPLY - BATTLESTRINGS_TABLE_START] = sText_AbilityRaisedStatSharply,
    ...
    [STRINGID_PKMNOPENEYESCONCENTRATE - BATTLESTRINGS_TABLE_START] = sText_PkmnOpenEyesConcentrate,
    ...
    [STRINGID_OVERTIMEENTERS - BATTLESTRINGS_TABLE_START] = sText_OvertimeEnters,
    ...
    [STRINGID_CONNIPTIONFAILEDMESSAGE - BATTLESTRINGS_TABLE_START] = sText_ConniptionFailedMessage,
};
...
const u16 gFirstTurnOfTwoStringIds[] =
{
    ...
    [B_MSG_TURN1_AURALYSIS]     = STRINGID_PKMNOPENEYESCONCENTRATE,
