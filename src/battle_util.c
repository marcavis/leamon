    ...
    case ABILITYEFFECT_MOVE_END: // Think contact abilities.
        ...
        case ABILITY_JUSTIFIED:
             ...
             && CompareStat(battler, STAT_ATK, MAX_STAT_STAGE, CMP_LESS_THAN))
            {
                SET_STATCHANGER(STAT_ATK, 1, FALSE);
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_TargetAbilityStatRaiseOnMoveEnd1;
                effect++;
            }
            break;
        case ABILITY_AMULET_LINK:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             && TARGET_TURN_DAMAGED
             && IsBattlerAlive(battler)
        ...
        case ABILITY_WATER_COMPACTION:
             ...
             && CompareStat(battler, STAT_DEF, MAX_STAT_STAGE, CMP_LESS_THAN))
            {
                ...
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_TargetAbilityStatRaiseOnMoveEnd2;
                effect++;
            }
            break;
        ...
        case ABILITY_STEAM_ENGINE:
             ...
             && (moveType == TYPE_FIRE || moveType == TYPE_WATER))
            {
                ...
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_TargetAbilityStatRaiseOnMoveEnd3;
                effect++;
            }
            break;
...
static u32 CalcAttackStat(u16 move, u8 battlerAtk, u8 battlerDef, u8 moveType, bool32 isCrit, bool32 updateFlags)
{
    ...
    else if (gBattleMoves[move].effect == EFFECT_VOID_TRAIL)
    {
...
static u16 CalcTypeEffectivenessMultiplierInternal(u16 move, u8 moveType, u8 battlerAtk, u8 battlerDef, bool32 recordAbilities, u16 modifier)
{
    ...
    if (moveType == TYPE_FAIRY && defAbility == ABILITY_OPPRESSION_AURA)
    {
        //TODO: mold breaker etc. should ignore oppression aura
        modifier = UQ_4_12(0.0);
        if (recordAbilities)
        {
            gLastUsedAbility = ABILITY_OPPRESSION_AURA;
            gMoveResultFlags |= (MOVE_RESULT_MISSED | MOVE_RESULT_DOESNT_AFFECT_FOE);
            gLastLandedMoves[battlerDef] = 0;
            gBattleCommunication[MISS_TYPE] = B_MSG_FAIRY_MISS;
            RecordAbilityBattle(battlerDef, ABILITY_OPPRESSION_AURA);
        }
    }
